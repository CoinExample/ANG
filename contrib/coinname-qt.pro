...
RESOURCES += src/qt/coinname.qrc src/qt/coinname_locale.qrc
TRANSLATIONS += src/qt/locale/coinname_bg.ts \
                src/qt/locale/coinname_de.ts \
                src/qt/locale/coinname_en.ts \
                src/qt/locale/coinname_es.ts \
                src/qt/locale/coinname_fi.ts \
                src/qt/locale/coinname_fr.ts \
                src/qt/locale/coinname_it.ts \
                src/qt/locale/coinname_ja.ts \
                src/qt/locale/coinname_pl.ts \
                src/qt/locale/coinname_pt.ts \
                src/qt/locale/coinname_ru.ts \
                src/qt/locale/coinname_sk.ts \
                src/qt/locale/coinname_sv.ts \
                src/qt/locale/coinname_vi.ts \
                src/qt/locale/coinname_zh_CN.ts \
                src/qt/locale/coinname_zh_TW.ts
