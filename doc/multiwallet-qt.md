...
Only requiring some minor changes is pcoin.cpp.
...
Changes to pcoin.cpp
----------------------
pcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
