...
Only requiring some minor changes is dragoncoin.cpp.
...
Changes to dragoncoin.cpp
----------------------
dragoncoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
