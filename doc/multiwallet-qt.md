...
Only requiring some minor changes is ang.cpp.
...
Changes to ang.cpp
----------------------
ang.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
