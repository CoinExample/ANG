...
If you have json-rpc code that checks the contents of the error string, you need to chcoinnamee it to expect error objects of the form {"code":<number>,"message":<string>}, which is the standard.  See this thread:
