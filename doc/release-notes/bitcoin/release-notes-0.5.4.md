...
NOTE: 0.5.4rc3 is being renamed to 0.5.4 final with no chcoinnamees.
...
Build with thread-safe MingW libraries for Windows, fixing a dcoinnameerous memory corruption scenario when exceptions are thrown.
