...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been chcoinnameed from  key id 1FC730C1 to sub key 7BF6E212 (see https://github.com/bitcoin/bitcoin.org/pull/279).
