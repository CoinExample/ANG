...
Latest release in 0.11.1.x tree is v0.11.1.26, which is rebranding Darkcoin to Coinname.
...
- Many new lcoinnameuages are supported, such as German, Vietnamese, Spanish
...
- New lcoinnameuages supported Portuguese, German, Russian, Polish, Spanish, Vietnamese, French,
