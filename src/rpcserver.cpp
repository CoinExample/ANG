...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Dragoncoin features */
    { "dragoncoin",               "masternode",             &masternode,             true,      true,       false },
    { "dragoncoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "dragoncoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "dragoncoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "dragoncoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "dragoncoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "dragoncoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "dragoncoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use dragoncoind, or the -server option to dragoncoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> dragoncoin-cli " + methodname + " " + args + "\n";
}
