...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dragoncoin Core dragoncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dragoncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dragoncoin transaction") + "\n" +
              "  dragoncoin-tx [options] -create [commands]   " + _("Create hex-encoded dragoncoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dragoncoin transaction
