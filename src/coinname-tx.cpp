...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Coinname Core coinname-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  coinname-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coinname transaction") + "\n" +
              "  coinname-tx [options] -create [commands]   " + _("Create hex-encoded coinname transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coinname transaction
