...
/* Check free space asynchronously to prevent hcoinnameing the UI thread.
...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Coinname Core"),
     ...
     * override -datadir in the coinname.conf file in the default data directory
     * (to be consistent with coinnamed behavior)
     */
    if(dataDir != getDefaultDataDirectory())
...
void Intro::on_dataDirectory_textChcoinnameed(const QString &dataDirStr)
{
