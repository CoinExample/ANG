...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dragoncoin Core"),
     ...
     * override -datadir in the dragoncoin.conf file in the default data directory
     * (to be consistent with dragoncoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
