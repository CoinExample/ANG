    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Ang Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Ang Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  ang-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Ang Core is shutting down...") + "<br /><br />" +
