    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Pcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Pcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  pcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Pcoin Core is shutting down...") + "<br /><br />" +
