    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dragoncoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Dragoncoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dragoncoin Core is shutting down...") + "<br /><br />" +
