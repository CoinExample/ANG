    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dragoncoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dragoncoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dragoncoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dragoncoin Core"));
    ...
    openAction->setStatusTip(tr("Open a dragoncoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dragoncoin Core help message to get a list with possible Dragoncoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dragoncoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Dragoncoin Core"); // default title
