    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a pcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pcoin Core help message to get a list with possible Pcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Pcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pcoin network", "", count));
}
...
{
    QString strTitle = tr("Pcoin Core"); // default title
