...
const char* BIP71_MIMETYPE_PAYMENT = "application/pcoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/pcoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/pcoin-paymentrequest";
...
//
// OSX-specific way of handling pcoin: URIs and
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in pcoin: URIs
...
bool PaymentServer::processPaymentRequest(PaymentRequestPlus& request, SendCoinsRecipient& recipient)
{
    ...
    foreach(const PAIRTYPE(CScript, CAmount)& sendingTo, sendingTos) {
        ...
        if (ExtractDestination(sendingTo.first, dest)) {
            ...
            // Insecure payments to custom pcoin addresses are not supported
