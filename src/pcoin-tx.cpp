...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Pcoin Core pcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pcoin transaction") + "\n" +
              "  pcoin-tx [options] -create [commands]   " + _("Create hex-encoded pcoin transaction") + "\n" +
              "\n";
